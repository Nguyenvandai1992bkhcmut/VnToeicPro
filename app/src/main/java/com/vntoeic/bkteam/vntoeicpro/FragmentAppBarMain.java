...
public class FragmentAppBarMain extends Fragment implements DowloadTask.IDowload{
    ...
    public void setUplayout(View view) {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    ...
                    break;
                    case R.id.vocabularry:
                        runVocabularyActivity();
        ...
        ((RelativeLayout)view.findViewById(R.id.vocabularry)).setOnClickListener(onClickListener);
    ...
    private void runVocabularyActivity() {
