...
public class SectionVocabularryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    VocabularyFragment mFragment;

    public SectionVocabularryAdapter(Context context, VocabularyFragment vocabularyFragments, ModelSection[] sections) {
        this.mContext = context;
        this.mSections = sections;
        this.mFragment = vocabularyFragments;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        TagVocabularyAdapter adapter = new TagVocabularyAdapter(mContext, mFragment, tags);
