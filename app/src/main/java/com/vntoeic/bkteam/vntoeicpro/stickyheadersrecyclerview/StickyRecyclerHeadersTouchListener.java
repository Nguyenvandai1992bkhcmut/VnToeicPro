...
public class StickyRecyclerHeadersTouchListener implements RecyclerView.OnItemTouchListener {
  ...
  public StickyRecyclerHeadersAdapter getAdapter() {
    if (mRecyclerView.getAdapter() instanceof StickyRecyclerHeadersAdapter) {
      ...
      throw new IllegalStateException("A Recyclercom.timehop.stickyheadersrecyclerview.StickyRecyclerHeadersTouchListener.class.getSimpleName() + a " + StickyRecyclerHeadersAdapter.class.getSimpleName());
    }
  }
