...
public class Note {
    ...
    public static final int NORMAL_SIZE = Utils.dpToPx(32);

    public static final int MINIMAL_SIZE = Utils.dpToPx(25);

    public static final int CHOOSE_SIZE = Utils.dpToPx(74);
