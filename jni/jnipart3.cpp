...
funConvert(JNIEnv* env , jobject object , Part3 * part ){
    if(part==NULL)return NULL;

    jclass  cl = env -> FindClass("model/ModelPart3");
...
extern "C"{
JNIEXPORT jobject JNICALL
Java_sqlite_SqlitePart3_searchPart3Id(JNIEnv * env , jobject object ,jint id_){

    SqlitePart3 sqlite;
    int id =(int)id_;
    Part3*part =sqlite.searchPart3Id(id);
...
Java_sqlite_SqlitePart3_randomPart3(JNIEnv * env , jobject object ,jint number1){

    SqlitePart3 sqlite;
    int number =(int)number1;
    vector<Part3*>result =sqlite.randomPart3(number);
     jclass  cl = env -> FindClass("model/ModelPart3");
...
extern "C"{
JNIEXPORT jobjectArray JNICALL
Java_sqlite_SqlitePart3_randomPart3Subject(JNIEnv * env , jobject object ,jint subject1,jint number1){

    SqlitePart3 sqlite;
    int number =(int)number1;
    int subject= (int)subject1;
    vector<Part3*>result =sqlite.randomPart3Subject(subject,number);
     jclass  cl = env -> FindClass("model/ModelPart3");
...
extern "C"{
JNIEXPORT jobjectArray JNICALL
Java_sqlite_SqlitePart3_searchPart3Favorite(JNIEnv * env , jobject object){

    SqlitePart3 sqlite;

    vector<Part3*>result =sqlite.searchPart3Favorite();
     jclass  cl = env -> FindClass("model/ModelPart3");
...
extern "C"{
JNIEXPORT jobjectArray JNICALL
Java_sqlite_SqlitePart3_searchPart3Check(JNIEnv * env , jobject object){

    SqlitePart3 sqlite;

    vector<Part3*>result =sqlite.searchPart3Check();
     jclass  cl = env -> FindClass("model/ModelPart3");
